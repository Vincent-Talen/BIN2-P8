...
Table: Metabolic Mate equation (3b) static parameter values \label{tab:Metabolic-Rate-Equation-Parameter-Values}
...
Table: Ingestion Rate equation (3b) static parameter values \label{tab:Ingestion-Rate-Equation-Parameter-Values}
...
Table: Assimilation Efficiency equation (4) static parameter values \label{tab:Assimulation-Efficiency-Equation-Parameter-Values}
...
Table: Leaf decomposition rate equation (5) parameter values \label{tab:Leaf-Decomposition-Rate-Equation-Parameter-Values}
