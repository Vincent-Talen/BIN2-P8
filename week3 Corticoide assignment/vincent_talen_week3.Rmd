...
packages <- c("deSolve", "ggplot2", "gridExtra", "scales")
...
```{r idk, warning = FALSE, fig.align = "center", fig.height = 2.75}
...
addGeomLines <- function(simulations.names, simulations.data) {
  ...
  y <- scale_color_manual("", values = c("black", extra.colors), limits = c("Basic Simulation", simulations.names))
  ## Correct the displayed line types in the legend
